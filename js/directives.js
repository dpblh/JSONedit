    ...
    .directive('json', ["$compile", function($compile) {
        return {
            ...
            link: function(scope, element, attributes) {
                ...
                scope.setRules = function(value) {
                    scope.child.rules = value;
                };
                ...
                // recursion
                var switchTemplate =
                    '<span ng-switch on="getType(val, key)" >'
                    ...
                    + '</span>'
                    + '<span ng-switch-when="Rules"><teko-rules ng-model="val" ng-change="setRules(value)"></teko-rules></span>'
